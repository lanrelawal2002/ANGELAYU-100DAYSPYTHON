# my fourth version of the coffee machine project
# I incorporated Angela's dictionary key looping method.
#  and I topped up money by using a function with a return value.
...
def adjust_resources(drink_selected, resources_dict, working_dict, original_amount):
